...
MAXCOUNT=500
count=1
network=2a07:14c0:1 # your ipv6 network prefix
...
rnd_ip_block ()
{
    ...
    echo $network$a:$b:$c:$d:$e:$f
        echo /sbin/ip -6 addr add $network$a:$b:$c:$d:$e:$f/36 dev ens321 >> /root/ip.list2.sh
	echo /sbin/ip -6 addr del $network$a:$b:$c:$d:$e:$f/36 dev ens321 >> /root/ip.list3.sh
}
